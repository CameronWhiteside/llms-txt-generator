...
export async function GET() {
  return new NextResponse(
    JSON.stringify(
      {
        demo: {
          description: "Test the AI feedback revision functionality",
          ...
          expectedBehavior: {
            "Store original": "Original content should be stored in Durable Object",
            "AI revision": "AI should revise content based on feedback",
            "Store revised": "Revised content should be stored in Durable Object",
            "Cache consistency": "Should use the same cache key for both store and revision",
